...
import { possSelector, viewProblemSelector, selectedRobotSelector, resultProblemSelector, animNext, intervalSelector, animIDSelector, animPathsSelector } from "./GameSlice"
