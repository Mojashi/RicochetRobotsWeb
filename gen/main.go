...
func parseHands(g game.Game, str string) ([]hand, error) {
	...
	for _, hs := range strs[1:] {
		...
		y, _ := strconv.Atoi(as[2])
		x, _ := strconv.Atoi(as[1])
		nex := pos{Y: y, X: x}
		var dir game.Dir
